...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # After conv (stride=1, pad preserves H/W) then 2x2 pool with stride 2
        H_pool = H // 2
        W_pool = W // 2
        D_affine_in = num_filters * H_pool * W_pool

        # Hidden affine layer params
        self.params["W2"] = weight_scale * np.random.randn(D_affine_in, hidden_dim)
